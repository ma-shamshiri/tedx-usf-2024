...
export const ComingSoonSpeakersPage: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <Box className="block__header" textAlign="center" width="100%">
                ...
                >
                    <Typed
                        strings={[t("comingSoonSpeakersPageTitle")]}
                        typeSpeed={50}
                        backSpeed={20}
                        loop
                        backDelay={3000}
                ...
                >
                    {t("comingSoonSpeakersPageSubTitle")}
                </Text>
            </Box>
        </Box>
    );
...
// export default ComingSoonSpeakersPage;
